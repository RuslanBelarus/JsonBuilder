from JsonBuilder import Builder

project = Builder('National delicous', "Japanse")

@project.Generic
def index():
    project.json["css"]["img.border-radius"] = '20%'
    project.json["css"]["info.margin-left"] = '10%'
    project.json["css"]["info.margin-right"] = '10%'
    project.json["css"]["subname.background-color"] = 'red'
    ...
    project.AddLink('youtube', 'https://youtube.com')
    project.AddLink('youtube', 'https://youtube.com')
    project.AddLink('youtube', 'https://youtube.com')
